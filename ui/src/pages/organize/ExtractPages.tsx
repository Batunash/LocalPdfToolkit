...
import { pdfExtractPages } from '../../lib/tauri';
...
export function ExtractPages() {
  ...
  const handleExtract = async () => {
    ...
    setProgress(0);
    setProgressStage('Extracting Pages');
    ...
    try {
      ...
      const output = await pdfExtractPages(file.file.name, file.file.name.replace('.pdf', '_extracted.pdf'), pageRanges, true);
